...
src_prepare() {
	...
	eapply "${FILESDIR}/rokenhin-x-compile.patch"
	eapply "${FILESDIR}/roken-versionscriptmap.patch"
	eapply "${FILESDIR}/configureac-no-hosttools.patch"
	eapply "${FILESDIR}/check-compile-et_m4.patch"
	eautoreconf
	eapply_user
}
